...
export class Viewport {
  ...
  static setScene = (currentScene: Scene | null, newSceneIndex: number) => {
    Viewport.state.sceneManager.currentScene = Viewport.state.sceneManager.scenes[newSceneIndex];

    Viewport.state.sceneManager.set(
      this.state.sceneManager.currentScene,
      null,
      Viewport.state,
      Viewport.setScene,
      currentScene ? currentScene.passedParams[3] : null
    );
  };
}
